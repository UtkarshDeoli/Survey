      ...
      {!hide && (
        <div className="bg-primary-50 p-5 w-full">
          <div className="flex flex-col justify-center items-center p-5 gap-3 bg-white w-full">
            ...
            {media && (
              <div className="grid grid-cols-12 w-3/4">
                <p className="col-span-4 text-secondary-300">
                  Question {media}
                </p>
                <label className="flex items-center justify-center col-span-8 rounded-md cursor-pointer hover:bg-secondary-50">
                  ...
                  <input
                    {...register(
                      `questions.${index}.parameters.question_image`,
                    )}
                    type="file"
                    className="hidden"
                    accept={
            ...
            <div className="grid grid-cols-12 w-3/4">
              ...
              <input
                {...register(
                  `questions.${index}.parameters.validation_pattern`,
                )}
                type="text"
                className="border border-secondary-200 rounded-md p-2 col-span-8 focus:outline-none"
            ...
            <div className="grid grid-cols-12 w-3/4">
              ...
              <div className="col-span-8 flex flex-col gap-2">
                <input
                  {...register(
                    `questions.${index}.parameters.validation_message`,
                  )}
                  type="text"
                ...
                <p className="text-secondary-300 text-sm">
                  This field should contain the Regular Expression to validate
