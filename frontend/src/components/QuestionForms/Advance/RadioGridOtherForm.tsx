...
function RadioGridOtherForm({ id, register, setValue, handleDelete }: Props) {
  useEffect(() => {
    setValue(`questions.${id}.type`, "radio_grid_other");
...
export default RadioGridOtherForm;
